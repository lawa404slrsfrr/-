...
'''+W+''' ---------------------------------------------------
 '''+wd+'''  CRACK Insta Started !
    Please Wait .. 1H Or 2H 
    Prosess In BackGround !...... 
'''+W+''' ---------------------------------------------------
 '''
print(logo1)
agar=input(" Do You Want To Put The Results In Telegram Bot (y,yes or n,no) ")
...
def instagram1():
	...
	def loopPp():
		try:
			...
			print(" [ ! There Is No Combo In Your Phone Or The Path Is Wrong ! ]")
	loopPp()
